...
{
  set.seed(1)
  ann_model <- neuralnet(formula = player_won_ind ~ PC1+ PC2+ PC3, data = tennis3_train_pc, hidden=i, lifesign='full', lifesign.step=10000, threshold=.01, stepmax = 100000000)  
